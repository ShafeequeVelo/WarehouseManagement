...
public class WarehousePO extends ExtensibleObjectPO
{
     ...
     * <p>
     * 
     * @return true if the value of attribute 'location' is null, false
     *         otherwise
     * @generated
     */
    ...
    public void setCapacity(int aValue)
    {
        ...
        if (setAttributeValue(capacityAttribute, new Integer(aValue)))
        {
            onChange();
        }
    }
     ...
     * <p>
     * 
     * @return true if the value of attribute 'capacity' is null, false
     *         otherwise
     * @generated
     */
     ...
     * 
     * @param aLocale
     *            the locale to determine the attribute value
     * @return the value of the localized extensible object attribute, or null
     *         if it wasn't found
     * @generated
     */
    ...
    /**
     * Sets the value of the localized extensible object attribute "description"
     * for the specified locale.
     * <p>
     * 
     * @param aDescription
     *            the new value for the extensible object attribute
     * @param aLocale
     *            the locale to set the localized attribute value for
     * @generated
     */
     ...
     * 
     * @param anElement
     *            the element to check for participation
     ...
     * 'attributeValues'. The implementation just forwards the call to the
     * internal relation implementation 'attributeValuePOs'. The attribute
     * values of an extensible object.
     * 
     * @param anElement
     *            the element to check for participation
     * @return true, if the element is part of the relationship, false otherwise
