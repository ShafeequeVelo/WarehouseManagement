...
// Generator template: ORMFactory.xpt(checksum: 2057a08990e84907c4146df22b73c67e)
// =============================================================================
 ...
 * 
 * @see com.intershop.ts.component.warehouse.orm.internal.WarehousePO
 * @generated
 */
public class WarehousePOFactory extends Factory
{
     ...
     * 
     * @deprecated use
     *             "NamingMgr.getInstance().lookupFactory(WarehousePO.class)"
     *             instead
     * @generated
     */
    public static final String FACTORY_NAME = "com.intershop.ts.component.warehouse.orm.internal.WarehousePO";
    ...
    {
        return create(UUIDMgr.getInstance().createUUIDString(), domain.getUUID(), name);
    }
     ...
     * @param key
     *            the primary key to use for lookup
     * @return the object for the specified primary key or null, if it wasn't
     *         found
     * @generated
     */
     ...
     * 
     * @param key
     *            the alternate key to use for lookup
     * @return the object for the specified alternate key or null, if it wasn't
     *         found
     * @generated
     */
    ...
    /**
     * Locates instances of class WarehousePO based on the value of the
     * attribute 'domainID'.
     * 
     * @param value
     *            the value of the attribute 'domainID' to use for lookup
     * @return a list of instances of class WarehousePO that match the specified
     *         value of the attribute domainID
     ...
     *            the value of the attribute 'domainID' to use for lookup
     * @return a list of instances of class WarehousePO that match the specified
     *         value of attribute domainID
     * @generated
     */
    public ORMObjectCollection getObjectsByDomainID(String value)
    {
        return getEngine().getPersistenceManager().getObjectsByAttribute(value, WarehousePO.domainIDAttribute,
                        getClassDescription());
    }
     ...
     * result objects or not. If caching is used, all results are cached in the
     * collection and it can be iterated multiple times without repeated queries
     * to the database. If no caching is used, the results will not be cached by
     * the collection. Each call to iterator will execute the query again. This
     * mode should be used when large result sets are expected and caching all
