...
/**
 * This class represents the alternate key for objects of type WarehousePO. The
...
public class WarehousePOAlternateKey extends ORMObjectAlternateKey
{
    ...
    /**
     * Creates an empty alternate key. After creation of a new key object you
     * must call the corresponding set<i>Attribute</i> method(s) to set the
     * value(s) of the alternate key.
     * 
     * @generated
     */
    ...
    /**
     * Checks if the key is a null key, e.g. all alternate key attributes are
     * still set to null. Such keys are ambiguous and can therefore not be used
     ...
     * 
     * @return true, if the other object is an alternate key object of the same
     *         type and all key attributes are equal
     * @generated
     */
    ...
    public String toString()
    {
        StringBuilder buf = new StringBuilder(
                        "com.intershop.ts.component.warehouse.orm.internal.WarehousePOAlternateKey[");
